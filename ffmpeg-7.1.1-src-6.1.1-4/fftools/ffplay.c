...
static void event_loop(VideoState *cur_stream)
{
    ...
    for (;;) {
		...
		break;
	      ...
	      {
		if ((sr_show_start==1)&&(sr_show_nodisp==0))
		{
		  sr_show_nodisp=1;
		  sr_show_start=0;
	          g_paint_ini();
		...
		else
		{
		  ...
		  {
		    if ((pl_cover_has==1)&&(pl_cover_close==1))
		    {
		      g_paint_ini();
		      pl_disp_bar(cur_stream);
		      g_paint_dirview();
...
static int  sr_river_show(VideoState *cur_stream)
{
  ...
  u_echo_str4screenstring(10,screen_h -18*2 -9-14-10,str2,300,2,0);
...
static int  sr_river_f_cons_test(VideoState *cur_stream,int ptr)
{
  ...
  u_echo_str4screenstring(10,screen_h -18*2 -9 -14-10,str1,300,0,1);
...
int g_paint_dirview(void)
{
  ...
  for (i=0;i<g_dirview_ptr;i++)
  {
    ...
    if (ftree_filenamebuff_ptr<=m/14)
    {
      g_dirview_top=0;
      continue;
    }
    ...
    s=(m-2)*((float)ftree_filenamebuff_n+m/14 )/(float)ftree_filenamebuff_ptr;
 ...
 int ftree_disp_dir(VideoState *cur_stream)
{
  ...
  for (n4=0;n4<h;n4++)
  {
    ...
    {
      strcat(disp_buff[n4],"  ");
      strcat(disp_buff[n4],ftree_filenamebuff_ext[ ftree_filenamebuff_n+n4]);
      strcat(disp_buff[n4],"  ");
      strcat(disp_buff[n4],ftree_filenamebuff_size[ftree_filenamebuff_n+n4]);
      strcat(disp_buff[n4],"  ");
      strcat(disp_buff[n4],ftree_filenamebuff_date[ftree_filenamebuff_n+n4]);
    }
  }
  ...
  for (n4=0;n4<h;n4++)
  {
    ...
    u_echo_str4screenstring(x+3+n5*7+2*deb_ch_w+4 ,y+n4*deb_ch_h ,strptr ,6000,0,0);
  }
  ...
  for (k=ftree_filenameplay;k<=ftree_filenameplay+j;k++)
  {
    ...
    if ((n4>=0)&&(n4<h)&&(n4<350)) 
    {
        ...
        u_echo_str4screenstring(x+3+n5*7+2*deb_ch_w+4 ,y+n4*deb_ch_h ,strptr ,6000,1,0);
    }
  }
