...
int g_button_paint_value_max;
int g_button_paint_value[300];
int g_mouse_down;
...
static void fill_border(int xleft, int ytop, int width, int height, int x, int y, int w, int h)
{
    ...
    h2 = height - (y + h) -/*deb_ch_h*/18*2 -deb_ch_d ;
    ...
    fill_rectangle(
                   xleft, ytop,
                   w1, height -/*deb_ch_h*/18*2 -deb_ch_d
                   );
    fill_rectangle(
                   xleft + width - w2, ytop,
                   w2, height -/*deb_ch_h*/18*2 -deb_ch_d
                   );
    fill_rectangle(
                   xleft + w1, ytop,
                   width - w1 - w2, h1
    ...
    fill_rectangle(
                   xleft + w1, ytop + height - h2 -/*deb_ch_h*/18*2 -deb_ch_d,
                   width - w1 - w2, h2
                   );
}
                                   ...
                                   int pic_width, int pic_height, AVRational pic_sar)
{
    ...
    //daipozhi modified
    height = scr_height/**/-/*deb_ch_h*/18*2 -9 -deb_ch_d /**/;
    ...
    // daipozhi modified
    y = (scr_height - height/**/-/*deb_ch_h*/18*2 -9 -deb_ch_d/**/) / 2;
    ...
    // test end 
	  ...
	  if (g_dirview_mouse_down==1)
	  {
	    ...
	    if (yy2>g_dirview_mouse_down_y)
	      ...
	      g_dirview_top=g_dirview_top+yy3+yy4;
...
static int  deb_sr_river_show(VideoState *cur_stream)
{
  ...
  // display comment
  deb_echo_str4screenstring(10,screen_h-18*2-9-deb_ch_d-14-10,"Every Column Has 256 Samples(44.1KHz)(5.80ms)",45+1,2,0);
...
static int  deb_sr_river_f_cons_test(VideoState *cur_stream,int ptr)
{
  ...
  fill_rectangle(0 ,0 , cur_stream->width , cur_stream->height -/*deb_ch_h*/18*2-9-deb_ch_d ); 
  ...
  // display comment
  deb_echo_str4screenstring(10,screen_h-18*2-9-deb_ch_d-14-10,"Every Column Has 256 Samples(44.1KHz)(5.80ms)",45+1,0,1);
...
int g_draw_circle4button(/*int x,int y,*/int r/*,int vid,int color1,int color2,int color3,int st*/)
{
  ...
  g_data2[0][g_data2_ptr[0]][0]=x0;
  g_data2[0][g_data2_ptr[0]][1]=y0;
  ...
  while (1)  //part 1
  {
    ...
    g_data2_ptr[0]++;
    if (g_data2_ptr[0]>=10000) return(0);
  ...
  for (i=0;i<g_data2_ptr[0];i++)   //copy to other seg
  {
    g_data2[1][i][0]=g_data2[0][i][0];
    g_data2[1][i][1]=g_data2[0][i][1]*(-1);
    
    g_data2[2][i][0]=g_data2[0][i][0]*(-1);
    g_data2[2][i][1]=g_data2[0][i][1]*(-1);
    
    g_data2[3][i][0]=g_data2[0][i][0]*(-1);
    g_data2[3][i][1]=g_data2[0][i][1];
  }

  g_data2_ptr[1]=g_data2_ptr[0];
  g_data2_ptr[2]=g_data2_ptr[0];
  g_data2_ptr[3]=g_data2_ptr[0];

  for (j=0;j<4;j++)  //move circle
  {
    for (i=0;i<g_data2_ptr[j];i++)
    {
      g_data2[j][i][0]=g_data2[j][i][0]+x;
      g_data2[j][i][1]=g_data2[j][i][1]+y;
    }
  }
  ...
  for (j=0;j<4;j++)
  {
    for (i=0;i<g_data2_ptr[j];i++)
    {
      ...
      if ((x0<0)||(x0>=300)) return(0);
      if ((y0<0)||(y0>=300)) return(0);
      
      g_data2_buff[x0][y0]=1;
/*
        if (vid)
        {
...
int g_get_button_val(int r)
{
  ...
  g_button_paint_value_max=0;
  
  for (i=0;i<300;i++) g_button_paint_value[i]=0;
  ...
  for (i=0;i<r*2;i++)
  {
    ...
    if (j==1)
    {
      g_button_paint_value[i]=y2-k;
    }
  }
  
  //printf("paint button value max=%d,\n",g_button_paint_value_max);
  
  //for (i=0;i<16;i++)
  //    printf("paint button value=%d,\n",g_button_paint_value[i]);
        ...
        if (g_button_enable[i]==1)
        {
          if (g_button_black[i]==0)
          {
            ...
            else
            {
              if (vid)
              {
                  i5=i1-(64-64*g_button_paint_value[o]/g_button_paint_value_max)*i1/255;
                  i6=i2-(64-64*g_button_paint_value[o]/g_button_paint_value_max)*i2/255;
                  i7=i3-(64-64*g_button_paint_value[o]/g_button_paint_value_max)*i3/255;
          ...
          else
          {
            ...
            else
            {
              if (vid)
              {
                  i5=i1+64*g_button_paint_value[o]/g_button_paint_value_max;
    ...
    while(j<len)
    {
      ...
      if ((u_err==0)&&(u_err2==0))
      {
		  ...
		  if (g_button_black[i]==0)
		  {
                    ...
                    {
                      i5=i1-(64-64*g_button_paint_value[r+n]/g_button_paint_value_max)*i1/255;
                      i6=i2-(64-64*g_button_paint_value[r+n]/g_button_paint_value_max)*i2/255;
                      i7=i3-(64-64*g_button_paint_value[r+n]/g_button_paint_value_max)*i3/255;
                    }
                  }
                  else
                  {
                    ...
                    {
                      i5=i1+64*g_button_paint_value[r+n]/g_button_paint_value_max;
                      i6=i2+64*g_button_paint_value[r+n]/g_button_paint_value_max;
                      i7=i3+64*g_button_paint_value[r+n]/g_button_paint_value_max;
                    }
                  }
