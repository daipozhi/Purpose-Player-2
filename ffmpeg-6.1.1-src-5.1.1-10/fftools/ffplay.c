        ...
        for (o=0;o<3;o++)
        {
          ...
          else
          {
            if (g_scrollbar_black[i]==0)
            {
              ...
              {
                  deb_set_dot(j+n,q+o,i1*7/10,i2*7/10,i3*7/10);
              }
            }
            else
            {
              ...
              {
                  deb_set_dot(j+n,q+o,255-(255-i1)*7/10,255-(255-i2)*7/10,255-(255-i3)*7/10);
              }
            }
          }
        }
        ...
        for (o=0;o<14;o++)
        {
          ...
          else
          {
            if (g_scrollbar_black[i]==0)
            {
              ...
              {
                  deb_set_dot(r+n,t+o,i1*7/10,i2*7/10,i3*7/10);
              }
            }
            else
            {
              ...
              {
                  deb_set_dot(r+n,t+o,255-(255-i1)*7/10,255-(255-i2)*7/10,255-(255-i3)*7/10);
              }
            }
          }
        }
  ...
  for (i=0;i<g_radiobutton_ptr;i++)
  {
    ...
    else
    {
      if (g_radiobutton_black[i]==0)
      {
        ...
        if (g_radiobutton_value[i]==1)
        {
          g_draw_circle(j+l/2,k+m/2,(l/2)*0.7-1,vid,k1*7/10,k2*7/10,k3*7/10,1);    
        }
      }
      else
      {
        ...
        if (g_radiobutton_value[i]==1)
        {
          g_draw_circle(j+l/2,k+m/2,(l/2)*0.7-1,vid,255-(255-k1)*7/10,255-(255-k2)*7/10,255-(255-k3)*7/10,1);    
        }
      }
    }
  }
