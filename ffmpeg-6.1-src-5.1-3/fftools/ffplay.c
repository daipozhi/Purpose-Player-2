...
int  g_label_color[G_BUTTON_NUM][3];
char g_label_black[G_BUTTON_NUM];
char g_label_text[G_LABEL_NUM][FN_SIZE];
char g_label_text_bl[ G_BUTTON_NUM];
int  g_label_text_color[ G_BUTTON_NUM][3];
int  g_label_ptr;
...
static void fill_border(int xleft, int ytop, int width, int height, int x, int y, int w, int h)
{
    ...
    h2 = height - (y + h) -deb_ch_h*2 -deb_ch_d ;
    ...
    fill_rectangle(
                   xleft, ytop,
                   w1, height -deb_ch_h*2 -deb_ch_d
                   );
    fill_rectangle(
                   xleft + width - w2, ytop,
                   w2, height -deb_ch_h*2 -deb_ch_d
                   );
    fill_rectangle(
                   xleft + w1, ytop,
                   width - w1 - w2, h1
    ...
    fill_rectangle(
                   xleft + w1, ytop + height - h2 -deb_ch_h*2 -deb_ch_d,
                   width - w1 - w2, h2
                   );
}
...
static void refresh_loop_wait_event(VideoState *is, SDL_Event *event) {
	...
	// daipozhi modified
		...
		if (deb_m_ref==1)
		{
		  ...
		  g_paint_button(deb_st_video);
		  g_paint_label(deb_st_video);
		  g_paint_checkbox(deb_st_video);
		  g_paint_radiobutton(deb_st_video);
    ...
    for (;;) {
	  ...
	  else
	  {
        ...
        case SDL_WINDOWEVENT:
		    ...
		    g_move_dirview(0,0,1,cur_stream->width,cur_stream->height-18*2);
		    

                    // for testing of mini GUI lib
                    /*
       		    g_move_dirview(0,0,18*7+1,cur_stream->width,cur_stream->height-18*9);
       		    */
       		    // test end
...
int main(void /*int argc, char **argv*/)
{
    ...
    g_create_dirview(0,1,is->width,is->height-18*2);
    
    
    // for testing of mini GUI lib
    /*
    g_create_dirview(0,18*7+1,is->width,is->height-18*9);
    */
    // test end
    
    g_create_scrollbar(5,is->height-18*2+1,is->width-5-180-5-5,16,1,0,0,0,0);
    g_create_scrollbar(is->width-5-180,is->height-18*2+1,180,16,1,0,0,0,0);
    
    strcpy(str1,"Play");
    g_create_button((is->width-80)/2,is->height-18+1,80,16,1,0,0,0,str1,5,4);
    g_set_button_text_color(0,0,255,255,255);
    
    strcpy(str1,"");
    g_create_button(is->width-120-5,is->height-18+1,120,16,1,0,0,0,str1,5,4);
    g_set_button_text_color(1,0,255,255,255);

    strcpy(str1,"");
    g_create_label(5,is->height-18+1,150,16,0,255,255,255,str1,5);
    ...
    strcpy(str1,"***abcd");
    g_create_lineedit("text",(is->width-310)/2+45+5,1,200,16,0,255,255,255,str1,(200-4)/7,50,0);
    g_set_lineedit_text_color(0,1,0,0,0);
    
    strcpy(str1,"123");
    g_create_lineedit("number",(is->width-310)/2+45+5,1+18,200,16,0,255,255,255,str1,(200-4/7),10,2);
    g_set_lineedit_text_color(1,1,0,0,0);
    
    strcpy(str1,"");
    g_create_lineedit("password",(is->width-310)/2+45+5,1+18*2,200,16,0,255,255,255,str1,(200-4)/7,20,0);
    ...
    g_create_checkbox((is->width-310)/2+45+5,1+18*3,16,16,0,255,255,255);
    g_create_checkbox((is->width-310)/2+45+5,1+18*4,16,16,0,255,255,255);

    g_create_radiobutton((is->width-310)/2+45+5,1+18*5,16,16,0,255,255,255,0);
    g_create_radiobutton((is->width-310)/2+45+5+16+5,1+18*5,16,16,0,255,255,255,0);

    g_create_radiobutton((is->width-310)/2+45+5,1+18*6,16,16,0,255,255,255,1);
    g_create_radiobutton((is->width-310)/2+45+5+16+5,1+18*6,16,16,0,255,255,255,1);
    */
    // test end 
...
so   d2=(h-14*2-7)/151
*/  
  d2=((float)screen_h-14*2-7-14-10-10)/151;
...
static int  deb_sr_river_show(VideoState *cur_stream)
{
  ...
  // display comment
  deb_echo_str4screenstring(10,screen_h-14*2-deb_ch_d-14-10,"Every Column Has 256 Samples(44.1KHz)(5.80ms)",45+1,2,0);
...
static int  deb_sr_river_f_cons_test(VideoState *cur_stream,int ptr)
{
  ...
  // display comment
  deb_echo_str4screenstring(10,screen_h-14*2-deb_ch_d-14-10,"Every Column Has 256 Samples(44.1KHz)(5.80ms)",45+1,0,1);
...
int g_create_button(int x,int y,int w,int h,int black_button,int color1,int color2,int color3,char *cap,int cap_size,int cutcorner)
{
  ...
  g_button_black[g_button_ptr]=black_button;
...
int g_create_scrollbar(int x,int y,int w,int h,int black_bar,int color1,int color2,int color3,int hori)
{
  ...
  g_scrollbar_posi[g_scrollbar_ptr][0]=x;
  g_scrollbar_posi[g_scrollbar_ptr][1]=y;
  g_scrollbar_posi[g_scrollbar_ptr][2]=w;
  g_scrollbar_posi[g_scrollbar_ptr][3]=h;
  
  g_scrollbar_color[g_scrollbar_ptr][0]=color1;
  g_scrollbar_color[g_scrollbar_ptr][1]=color2;
  g_scrollbar_color[g_scrollbar_ptr][2]=color3;

  g_scrollbar_black[g_scrollbar_ptr]=black_bar;

  g_scrollbar_cutcorner[g_scrollbar_ptr]=2;
  
  g_scrollbar_hori[g_scrollbar_ptr]=hori;
...
int g_create_label(int x,int y,int w,int h,int black_label,int color1,int color2,int color3,char *text,int text_size)
{
  ...
  g_label_color[g_label_ptr][0]=color1;
  g_label_color[g_label_ptr][1]=color2;
  g_label_color[g_label_ptr][2]=color3;

  g_label_black[g_label_ptr]=black_label;
...
int g_create_lineedit(const char *type,int x,int y,int w,int h,int black_lineedit,int color1,int color2,int color3,char *txt,int len_screen,int len_real,int dec)
{
  ...
  g_lineedit_posi[g_lineedit_ptr][0]=x;
  g_lineedit_posi[g_lineedit_ptr][1]=y;
  g_lineedit_posi[g_lineedit_ptr][2]=w;
  g_lineedit_posi[g_lineedit_ptr][3]=h;
  
  g_lineedit_color[g_lineedit_ptr][0]=color1;
  g_lineedit_color[g_lineedit_ptr][1]=color2;
  g_lineedit_color[g_lineedit_ptr][2]=color3;

  g_lineedit_black[g_lineedit_ptr]=black_lineedit;
  ...
  strcpy(g_lineedit_text[g_lineedit_ptr],txt);
  ...
  if (strcmp(type,"text")==0)  //text
  {
    ...
    g_lineedit_type[g_lineedit_ptr]='c';
  }
  else if (strcmp(type,"number")==0) //number string
  {
    ...
    g_lineedit_type[g_lineedit_ptr]='n';
  }
  else if (strcmp(type,"password")==0) //password
  {
    ...
    g_lineedit_type[g_lineedit_ptr]='p';
  }
  else return(-1);
...
int g_create_checkbox(int x,int y,int w,int h,int black_box,int color1,int color2,int color3)
{
  ...
  g_checkbox_posi[g_checkbox_ptr][0]=x;
  g_checkbox_posi[g_checkbox_ptr][1]=y;
  g_checkbox_posi[g_checkbox_ptr][2]=w;
  g_checkbox_posi[g_checkbox_ptr][3]=h;
  
  g_checkbox_color[g_checkbox_ptr][0]=color1;
  g_checkbox_color[g_checkbox_ptr][1]=color2;
  g_checkbox_color[g_checkbox_ptr][2]=color3;

  g_checkbox_black[g_checkbox_ptr]=black_box;
...
int g_create_radiobutton(int x,int y,int w,int h,int black_button,int color1,int color2,int color3,int grp)
{
  ...
  g_radiobutton_posi[g_radiobutton_ptr][0]=x;
  g_radiobutton_posi[g_radiobutton_ptr][1]=y;
  g_radiobutton_posi[g_radiobutton_ptr][2]=w;
  g_radiobutton_posi[g_radiobutton_ptr][3]=h;
  
  g_radiobutton_color[g_radiobutton_ptr][0]=color1;
  g_radiobutton_color[g_radiobutton_ptr][1]=color2;
  g_radiobutton_color[g_radiobutton_ptr][2]=color3;

  g_radiobutton_black[g_radiobutton_ptr]=black_button;

  g_radiobutton_value_group[g_radiobutton_ptr]=grp;
...
int g_paint_radiobutton(int vid)
{
  ...
  for (i=0;i<g_radiobutton_ptr;i++)
  {
    ...
    {
      g_draw_circle(j+l/2,k+m/2,(l/2)*0.7-1,vid,k1,k2,k3,1);    
    }
  }
