...
Purpose player 2  6.1

this is a open source software,based on FFmpeg,play audio and video
on Windows and Ubuntu,and it can display "sound river".

there is a directory "ffmpeg-7.1-src-6.1" ,decompress "ffmpeg-7.1.tar.xz",
it create a directory "ffmpeg-7.1" ,
use files in "ffmpeg-7.1-src-6.1/fftools" to replace same name files in directory "ffmpeg-7.1/fftools",
...
这里有目录ffmpeg-7.1-src-6.1,解压ffmpeg-7.1.tar.xz,将创建ffmpeg-7.1目录, 
用ffmpeg-7.1-src-6.1/fftools里的文件,替换掉ffmpeg-7.1/fftools里的同名文件,
